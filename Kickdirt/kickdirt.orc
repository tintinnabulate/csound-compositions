...
instr 1		; "Electric guitar" lead with precision phasing
idur	=	p3
ipch	=	p4
iamp	=	p5
ifn	=	p6
...
it	=	16 / idur
	...
	itempo=130 
	iphasebeats=16
	; Set frequency difference so that one complete phasing cycle
	; takes a specified number of beats
	ifreqdiff = 1 / ( (60 / itempo) * iphasebeats )
	aosc	oscil	kosc2, kosc, ifn, -1
	aosc2	oscil	kosc2, kosc + (ifreqdiff/2), ifn, -1
	aosc3	oscil	kosc2, kosc - (ifreqdiff/2), ifn, -1
